...
def start_tfidf(questions, num_threads, method_name, is_title, ngram, debug_top_items, tfidf_models, vector_models, neighbors, minimal_word_idf_weights, power_factors):
    ...
    for i in range(num_threads):
        thread = multiprocessing.Process(target=resolve_questions, args=(questions_queue, method_name, is_title, ngram, debug_top_items, tfidf_models, vector_models, neighbors, minimal_word_idf_weights, power_factors))
        thread.start()
